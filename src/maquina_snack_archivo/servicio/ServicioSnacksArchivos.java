...
public class ServicioSnacksArchivos implements IServicioSnacks {
    ...
    private void cargarSnacksIniciales(){
        this.agregarSnack(new Snack("Papas", 7000));
        this.agregarSnack(new Snack("Gaseosa", 3000));
        this.agregarSnack(new Snack("Tostado", 6500));
        this.agregarSnack(new Snack("Pizza", 10000));
    }
    ...
    private List<Snack> obtenerSnacks(){
        ...
        return snacks; //Retornamos la lista
    }

    @Override
    public void agregarSnack(Snack snack) {
        //Agregamos el nuevo snack, paso 1. a la lista
    ...
    private void agregarSnackArchivo(Snack snack){
        ...
        var archivo = new File(NOMBRE_ARCHIVO);
        try{
            anexar = archivo.exists(); //Esta línea es muy importante porque agrega la información al archivo
            var salida = new PrintWriter(new FileWriter(archivo, anexar));
            salida.println(snack.escribirSnack());
            salida.close(); //se escribe la información al archivo
        } catch (Exception e){
    ...
    public void mostrarSnacks() {
        ...
        //Mostramos la lista de snacks em el archivo
